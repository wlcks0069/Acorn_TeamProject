	...
	<div class="container">
		<div class="input-form-background row">
			<div class="input-form col-md-12 mx-auto">
				<h2 class="mb-3 fw-bold">GP Project ID 찾기</h2>
				<form class="validation-form" novalidate action=gpid_search
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							<label class="fw-bold">나이</label> <select class="form-select form-select-sm mb-3"
								name="gpmAge">
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							<input class="form-control btn btn-primary fw-bold" type="button" value="메일 주소 찾기"
								id="id_search">
						</div>
					</div>
				</form>
